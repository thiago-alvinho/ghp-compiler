...
void atualizar(string tipo, string nome, string tamanho);
...
ATRI 		:TK_ID '=' PRIM
			{
				...
				if(variavel.tipado == false) {
					if($3.tipo == "string" ){
						atualizar($3.tipo, $1.label, $3.tamanho);
